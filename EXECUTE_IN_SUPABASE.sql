...
-- Dropdown Options Migration for OCR Invoice Processor
-- Date: 2025-06-05
...
-- Add trigger for updated_at timestamp (function might already exist from invoices table)
...
-- Insert default dropdown options as database records
...
-- Verification query - run this to confirm the migration was successful
SELECT 
    field_name,
